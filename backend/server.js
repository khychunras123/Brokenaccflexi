...
if (fs.existsSync(envPath)) {
    try {
        if (typeof process.loadEnvFile === 'function') {
            ...
            // Fallback line-by-line parser for Node.js versions older than 20.6.0
            ...
            console.log('Environment variables manually loaded from:', envPath);
        }
    } catch (err) {
...
app.get('/api/verify-key', (req, res) => {
    try {
        ...
        const matchedEnv = envKeys.find(([envName, envVal]) => envVal === key && envName.endsWith('_KEY'));
